...
public class OpenshiftProtocolEndpoint extends OIDCLoginProtocolService {
    ...
    @Path("token")
    public Object token() {
        OpenShiftTokenReviewEndpoint endpoint = new OpenShiftTokenReviewEndpoint(session);
    ...
    public static UriBuilder tokenReviewnUrl(UriBuilder baseUriBuilder) {
        return tokenUrl(baseUriBuilder).path(OpenShiftTokenReviewEndpoint.class, "tokenReview");
    }
